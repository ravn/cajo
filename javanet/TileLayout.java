 ...
 * <i>within</i> the container.  Its purpose is to support arbitrarily
 * complex component layouts, of an unlimited number of components, within a
 * single container. It can easily create complex layouts that would
 * otherwise require many subpanels, and multiple standard layout managers.
 * It also can create layouts that are completely <i>impossible</i>, with
 * standard layout managers. These features make this layout manager
 * extremely flexible, and makes advanced layouts extremely fast. It just
 * may be, the last and only LayoutManager you'll ever need.<p>
 *
 * Components can be laid out above, below, left, or right of either a
 * referenced component in the panel, or to the panel itself. Its width
 * and height can be specified with similar flexibility. Absolute and
 * proportional bounds are also supported. In typical use, one or more
 * <i>'reference'</i> tiles are laid, and the rest of the components are
 * set relative to them.<p>
 *
 ...
 * to first; the manager lays them out similarly. Therefore, in order to
 * layout relative to another component, the reference component must be
 * added <u>after</u> the dependent one. I know this can be a drag at first,
 * but it becomes critically important when components are laid out on top
 * of others, or overlapping. This is a <i>super cool</i> capability of this
 * layout manager.
 *
...
public final class TileLayout implements LayoutManager2, Serializable {
   ...
   private void align(Dimension cont, Object cons[], Component comp) {
      ...
      Rectangle pref =
         new Rectangle(tile.getLocation(), comp.getPreferredSize());
...
//      if (pref.height < d.height) pref.height = d.height;
   ...
   /**
    * This constant specifies placement of the component even with the
    * left border of the provided reference component, otherwise to the
    * container itself.
    */
   public static final int NOINDENT = 0x000000;
   /**
    * This constant specifies placement of the component with its right
    * border one pixel to the left of the provided reference component,
   ...
   /**
    * This constant specifies placement of the component with its right
    * border evenly aligned with the right border of the provided reference
    * component, otherwise to the container itself.
    */
   public static final int FULLINDENT = 0x000004;
   /**
    * This constant specifies placement of the left border of the component
    * one pixel to the right of the provided reference component origin,
    * otherwise to the container itself.
    */
   ...
   /**
    * This constant specifies placement of the component even with the
    * top border of the provided reference component, otherwise to the
    * container itself.
    */
   public static final int NOOFFSET = 0x000000;
   /**
    * This constant specifies placement of the component with its bottom
    * border one pixel above the provided reference component,
    * otherwise to the container itself.
    */
   public static final int TOPOFFSET = 0x000040;
   /**
    * This constant specifies placement of the component evenly between the
    * top and bottom borders of the provided reference component, otherwise
    * to the container itself.
    */
   ...
   /**
    * This constant specifies placement of the top border of the component
    * one pixel below the provided reference component origin, otherwise to
   ...
   /**
    * This constant specifies that the component have its preferred width,
    * as returned by its getPreferredSize method.
    */
   public static final int PREFWIDTH = 0x000000;
   /**
    * This constant specifies that the component be made wide enough such
    * that given its computed right margin, its left margin will align with
    * that of its container.
    */
   public static final int CLAMPLEFT = 0x001000;
   /**
    * This constant specifies that the component be made wide enough such
    * that given its computed origin, its right margin will align with that
    * of its container.
    */
   ...
   /**
    * Used in conjunction with a Rectangle constraint, the width value
    * represents the desired component offset as a percentage (2000 = 200.0%)
    * of a provided component, otherwise to the container itself.
    */
   public static final int PROPWIDTH = 0x008000;
   /**
    * This constant specifies that the component be made exactly as wide
    * as its reference component, otherwise as the container itself.
    */
   public static final int FULLWIDTH = 0x010000;

   /**
    * This constant specifies that the component have its preferred height,
    * as returned by its getPreferredSize method.
    */
   public static final int PREFHEIGHT = 0x000000;
   /**
    * This constant specifies that the component be made high enough such
    * that given its computed bottom margin, its top margin will align with
    * that of its container.
    */
   public static final int CLAMPTOP = 0x020000;
   /**
    * This constant specifies that the component be made high enough such
    * that given its computed origin, its bottom margin will align with that
    * of its container.
    */
   ...
   /**
    * This constant specifies that the component be made exactly as high
    * as its reference component, otherwise as the container itself.
    */
   ...
   /**
    * A frequently used position, used in conjunction with a reference
    * component, it will locate the component directly beneath, with the
   ...
   /**
    * A frequently used position, used in conjunction with a reference
    * component, it will locate the component directly adjacent, to its
    * right, with the same width and height.
    */
    ...
    * A frequently used position, used in conjunction with a reference
    * component, it will locate the component directly adjacent, to its
    * left, with the same width and height.
    */
   ...
   public TileLayout() {}
   /**
    * The primary component addition method. Components are added for
    * layout, and its constraints are provided as an Object array. Up to 4
    * constraints may be specified, and their order is not important. The
    * following are the applicable constraints:<ul><p>
    ...
    * @param constraints An Object[] containing 1 or more constraints.
    */
   public void addLayoutComponent(Component comp, Object constraints) {
      components.add(comp);
      components.add((Object[])constraints);
   }
   /**
    * This method will make the added component exactly the same size as
    * the container itself. It is useful for adding wallpaper.
   ...
   public void layoutContainer(Container parent) {
      ...
      for (int i = components.size() - 1; i > 0; i--)
         align(container, (Object[])components.get(i--),
