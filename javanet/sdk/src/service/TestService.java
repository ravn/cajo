...
/**
 * This class creates a service, with a corresponging client GUI. It is
 ...
 * publically invocable, so be careful. <i>(e.g. no static void main
 * function)</i>
...
public class TestService extends util.BaseService {
    ...
    * cajo federation</a>.
    * @param name The name under which to bind the service in the local rmi
    * registry
