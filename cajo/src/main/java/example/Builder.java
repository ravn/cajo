...
public class Builder {
	...
	public static void main(String args[]) {
		try {
			...
			proxy.strings = new String[] { "proxy_arrived", "proxy_started", "call_server", "proxy_ack", "proxy_hello",
					"server_call", "title", "response" };
			...
			proxy.container.add(s, new Object[] { new Integer(
					TileLayout.CENTERINDENT + TileLayout.CENTEROFFSET + TileLayout.PREFWIDTH + TileLayout.PREFHEIGHT),
					proxy.d });
			proxy.container.add(proxy.a,
					new Object[] { new Integer(
							TileLayout.NOINDENT + TileLayout.TOPOFFSET + TileLayout.PREFWIDTH + TileLayout.PREFHEIGHT),
							proxy.e });
			proxy.container
					.add(proxy.b,
							new Object[] { new Integer(TileLayout.NOINDENT + TileLayout.BOTTOMOFFSET
									+ TileLayout.PROPWIDTH + TileLayout.PREFHEIGHT), proxy.e,
									new Rectangle(0, 0, 4000, 0) });
			proxy.container.add(proxy.c, new Object[] { new Integer(
					TileLayout.RIGHTINDENT + TileLayout.NOOFFSET + TileLayout.PREFWIDTH + TileLayout.PREFHEIGHT),
					proxy.d });
			proxy.container.add(proxy.e,
					new Object[] { new Integer(
							TileLayout.LEFTINDENT + TileLayout.NOOFFSET + TileLayout.PREFWIDTH + TileLayout.PREFHEIGHT),
							proxy.d });
			proxy.container.add(proxy.d, new Object[] { new Integer(TileLayout.CENTERINDENT + TileLayout.CENTEROFFSET
					+ TileLayout.PREFWIDTH + TileLayout.PREFHEIGHT) });
			proxy.container.add(w, new Object[] { new Integer(
					TileLayout.NOINDENT + TileLayout.NOOFFSET + TileLayout.FULLWIDTH + TileLayout.FULLHEIGHT) });

			// serialize and save:
			FileOutputStream fos = new FileOutputStream("example/include/proxy.ser");
