 ...
 * changed by the server at runtime. A server would remote this object wrapper,
 * then use its changeObject method to redefine the functionality of the
 * client's reference dynamically. <i><u>Note</u>:</i> the wrapped object can be
 * of any type, and it need not even implement the gnu.cajo.invoke.Invoke
 * interface.
 * <p>
 * <p>
 * While being only 5 lines of Java source code, its capability is elegantly
 * sophisticated.
 *
...
public final class DynamicObject implements Invoke {
	 ...
	 *
	 * @param object
	 *            The initial encapsulated server functionality to be remoted
	 *            through this object.
	 */
	 ...
	 *
	 * @param method
	 *            The method name to be invoked on the wrapped object.
	 * @param args
	 ...
	 * @throws Exception
	 *             If the wrapped object rejected the invocation, for application
	 *             specific reasons.
	 */
	...
	/**
	 * This method is used to dynamically redefine the functionality of this wrapper
	 * at runtime. The remote client reference never changes, but what the reference
	 * does, can be updated by the server repeatedly.
	 *
	 * @param object
	 *            The new encapsulated functionality to be provided to the remote
	 *            clients.
	 */
