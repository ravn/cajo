...
public final class Cajo implements Grail {
   ...
   private static final class Searchable implements Invoke {
      ...
      private Searchable(Object object, Object target) {
         ...
         for (int i = 0; i < allFields.length; i++) {
            ...
            if   ((modifiers & Modifier.PUBLIC) != 0
               && (modifiers & Modifier.FINAL)  != 0) // static or instance
       ...
       * static <i>(or instance)</i> fields for a match with the set provided
       * by the client.
       */
      public Object invoke(String method, Object args) throws Exception {
   ...
   /**
    * This constructor creates and announces the cajo registry.
    * <br><i><u>Note</u>:</i> invoke gnu.cajo.invoke.Remote.config, and
    ...
    * number: 1198
    * @throws IOException If the multicast UDP socket could not be created
    */
    ...
    * do not want to do this.<br>
    * Also, this method will remote the registrar, and announce its startup
    * on the export of the first service object.
    ...
    * specified method and field set. The method and field set is a
    * <i>client</i> defined interface. It specifies the method signatures
    * and final fields required. By convention, client based load balancing
    * can be implemented simply selecting a reference from the returned array
    * <i>at random.</i>
    * <br><i><u>Note</u>:</i> if the interface declares any static final
    * fields, these will also be matched for type, and equality against final
    * static <i>(or instance)</i> fields on the remote object.
    ...
    * @throws Exception For reflection access, if prohibited by security
    * policy
    */
