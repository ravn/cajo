...
public interface Grail {
    ...
    * <i>client</i> defined interface. It specifies the method signatures and
    * final static fields required.<p>
    ...
    * <li> The remote object does not have to implement the method and field
    * set interface class, rather merely have the matching methods and static
    * final fields, if not more. The package of the client interface does
    * <i>not</i> matter either. This is technically known as <a href=http://en.wikipedia.org/wiki/Liskov_substitution_principle>
    ...
    * server types exactly, they can be subclasses, or coercable primitive
    * types.</ul><p>
    ...
    * remote objects are required to support
    * @return An array of remote object references, specific to the
    * framework, implementing the specified method and field collection
